...
public class ShipTest {
    ...
    void testGetAdjacentPositions1() {
        List<IPosition> expectedAdjacents = new java.util.ArrayList<IPosition>();
    ...
    /**
     * Test for the getAdjacentPositions method(Bigger boat).
     */
    @Test
     ...
     */
    @Test
    @DisplayName("Checks if the toString method gives the corret format")
    void testToString() {
     ...
     */
    @Test
    @DisplayName("Test for when the argument is null")
    void testShoot3() {
        assertThrows(AssertionError.class, () -> ship.shoot(null), "Error: method should not accept a null argument");
    }
     ...
     */
    @Test
    @DisplayName("Test for when the given position is outside the board")
    void testShoot4() {
        IPosition invalid = new Position(-1, -1); // assuming isInside() == false
        assertThrows(AssertionError.class, () -> ship.shoot(invalid), "Error: Method should confirm if position is within board range");
    }

    /**
     * Test for the occupies method (position is null).
     */
    @Test
    @DisplayName("Test for when method argument is null")
    void testOccupies3() {
        assertThrows(AssertionError.class, () -> ship.occupies(null), "Error: method should not accept a null argument");
    }

    /**
     * Test for the tooCloseTo method with another IShip (IShip is null).
     */
    @Test
    @DisplayName("Test for when method argument is null")
    void testTooCloseToShip3() {
        assertThrows(AssertionError.class, () -> ship.tooCloseTo((IShip) null),"Error: method should not accept a null argument.");
    }

    /**
     * Test for the tooCloseTo method with an IPosition (positions null).
     */
    @Test
    @DisplayName("Test for when method argument is null")
